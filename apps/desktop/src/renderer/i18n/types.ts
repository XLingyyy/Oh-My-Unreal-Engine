  ...
  drawer: {
    ...
    sourceBoundary: {
      ...
      reasons: {
        ...
        'mock-fixture': string;
        'no-live-question-data': string;
        'no-persisted-closure': string;
        'no-persisted-change-plan': string;
        'no-real-blueprint-workspace': string;
      };
      questionsNoLiveData: string;
      closureUnavailableTitle: string;
      closureUnavailableDetail: string;
      changePlanUnavailableTitle: string;
      changePlanUnavailableDetail: string;
      blueprintWorkspaceUnavailableTitle: string;
      blueprintWorkspaceUnavailableDetail: string;
      persistedClosureTitle: string;
      persistedPlansTitle: string;
      ...
      kindLabel: string;
      summaryLabel: string;
      diagnosisSummaryLabel: string;
      confidenceLabel: string;
      riskLabel: string;
      operationKindLabel: string;
      escalationReasonLabel: string;
      suggestedHumanActionLabel: string;
      yesLabel: string;
      noLabel: string;
      notRecordedLabel: string;
      tabSourceAria: (itemLabel: string, sourceLabel: string) => string;
      commandUnavailableQuestions: string;
      commandUnavailableClosure: string;
      commandUnavailableChangePlan: string;
      commandUnavailableBlueprintWorkspace: string;
    };
  };
  settingsPlaceholder: {
    title: string;
